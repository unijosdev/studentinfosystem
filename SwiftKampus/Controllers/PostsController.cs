...
namespace SwiftKampus.Controllers
{
    ...
    public class PostsController : BaseController
    {
        ...
        public PostsController(SchoolDbContext db) : base(db)
        {
        ...
        public ActionResult Details(int id, string category)
        {
            if (!String.IsNullOrEmpty(category))
            {
                ...
                //            select i;
                var items = _db.Posts.FirstOrDefault(i => i.Title.ToUpper().Contains(category.ToUpper()));
        ...
        public ActionResult RSS()
        {
            IEnumerable<SyndicationItem> posts =
                (from post in _db.Posts
                 where post.DateTime < DateTime.Now
                 orderby post.DateTime descending
                 select post).Take(PostPerFeed).ToList().Select(GetSyndicationItem);
        ...
        SyndicationItem GetSyndicationItem(Post post)
        {
